# Program Nexys Video SPI Flash with bitstream (persistent)
...
# Create MCS file for flash programming (Nexys Video uses 128Mbit flash)
write_cfgmem -format mcs -size 16 -interface SPIx4 \
    -loadbit "up 0x0 build/trigger_delay.bit" \
    -force -file build/trigger_delay.mcs

# Program the flash
create_hw_cfgmem -hw_device [lindex [get_hw_devices xc7a200t_0] 0] \
...
set_property PROGRAM.FILES [list "build/trigger_delay.mcs"] \
    [get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a200t_0] 0]]
...
set_property PROGRAM.CHECKSUM 0 [get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a200t_0] 0]]
startgroup
create_hw_bitstream -hw_device [lindex [get_hw_devices xc7a200t_0] 0] \
    [get_property PROGRAM.HW_CFGMEM_BITFILE [lindex [get_hw_devices xc7a200t_0] 0]]
